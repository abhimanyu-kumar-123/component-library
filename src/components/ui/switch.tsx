...
function Switch({
  ...
  return (
    <div
      ...
      data-slot="switch"
      className={cn(
        "inline-flex h-9 items-center rounded-[20px] border border-white bg-white/50 p-px shadow-[0px_10px_20px_rgba(0,0,0,0.1)] transition-[background,box-shadow] hover:bg-white hover:shadow-[0px_10px_10px_rgba(0,0,0,0.1)] has-[button:active]:bg-white has-[button:active]:shadow-[0px_10px_10px_rgba(0,0,0,0.1)]",
        className
      )}
      {...props}
    >
